...
# python people_counter.py --prototxt mobilenet_ssd/MobileNetSSD_deploy.prototxt --model mobilenet_ssd/MobileNetSSD_deploy.caffemodel --input videos/sample.mp4 --output output/output_01.avi
#
...
from mods.trackableobject import TrackableObject
